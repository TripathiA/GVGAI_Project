...
public class Test {
    ...
    public static void main(String[] args) {
		...
		// Available tracks:
		String myController = "tracks.singlePlayer.advanced.FastEvoMCTS.Agent";
		String mctsController = "tracks.singlePlayer.advanced.sampleMCTS.Agent";
...
//		}
		...
		int N = 10, L = 5, M = 1;
		int[] gameindices = {0,11,13,18,42,60,68,80,84,100}; 
		...
		{
			int actionIdx = 0;
			game = games[gameindices[i]][0];
			gameName = games[gameindices[i]][1];
			for(int j = 0; j < L; ++j){
