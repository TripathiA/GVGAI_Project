...
public class SingleTreeNode
{
    ...
    public SerializableStateObservation state;
    ...
    public SingleTreeNode(SerializableStateObservation state, SingleTreeNode parent, Random rnd) {
        this.state = state;
        this.parent = parent;
        this.m_rnd = rnd;
    ...
    public SingleTreeNode expand() {
        ...
        SerializableStateObservation nextState = state.copy();
    ...
    {
        SerializableStateObservation rollerState = state.copy();
    ...
    public double value(SerializableStateObservation a_gameState) {
    ...
    public boolean finishRollout(SerializableStateObservation rollerState, int depth)
    {
